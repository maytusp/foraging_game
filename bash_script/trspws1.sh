...
python -m scripts.torch_scoreg_layout.train_struct --social-network ws --comm_field 100 --no-agent-visible --num_networks 100 --seed 1 --self-play-option --total-timesteps 2500000000 --checkpoint-root checkpoints/scoreg
