...
model_name_map = {
                # "pop_ppo_3net_invisible/grid8_img3_ni2_nw4_ms40_freeze_dur6_1792000000",
            "pop_ppo_3net_invisible/grid8_img3_ni2_nw4_ms40_freeze_dur12_range2_2252800000": "0",

                }
mode = "train"
num_networks = 3
test_conditions =  ["zero"] 
metrics = ["sr", "length"]
    ...
    for setting_name in model_name_map:
        ...
        for seed in [1]:
            ...
            for pair in network_pairs:
                ...
                score_dict[pair] = load_score(f"../../logs/pickup_temporal/{model_name}/{pair}/{combination_name}/seed{seed}/mode_{mode}/{test_condition}/score.txt")
