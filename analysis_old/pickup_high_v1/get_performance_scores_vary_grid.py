...
model_name_map = {
                 "test_grid_size_5/pop_ppo_3net_invisible/grid5_img3_ni2_nw4_ms10_332800000": "5x5",
                  "test_grid_size_6/pop_ppo_3net_invisible/grid5_img3_ni2_nw4_ms10_332800000": "6x6",
                  "test_grid_size_7/pop_ppo_3net_invisible/grid5_img3_ni2_nw4_ms10_332800000": "7x7",
                  "test_grid_size_8/pop_ppo_3net_invisible/grid5_img3_ni2_nw4_ms10_332800000": "8x8",
                  "test_grid_size_9/pop_ppo_3net_invisible/grid5_img3_ni2_nw4_ms10_332800000": "9x9",
                }
mode = "test"
num_networks = 3
...
for test_condition in test_conditions:
    for setting_name in model_name_map:
        grid_size ,model_name, combination_name  = setting_name.split("/")
        ...
        for seed in [1,2,3]:
            ...
            for pair in network_pairs:
                ...
                score_dict[pair] = load_score(f"../../logs/vary_grid_size/pickup_high_v1/{grid_size}/{model_name}/{pair}/{combination_name}/seed{seed}/mode_{mode}/{test_condition}/score.txt")
