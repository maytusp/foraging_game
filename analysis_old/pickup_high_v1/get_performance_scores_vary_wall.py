...
model_name_map = {
                 "num_walls_0/pop_ppo_3net_invisible/grid5_img3_ni2_nw4_ms10_332800000": "0",
                  "num_walls_1/pop_ppo_3net_invisible/grid5_img3_ni2_nw4_ms10_332800000": "1",
                  "num_walls_2/pop_ppo_3net_invisible/grid5_img3_ni2_nw4_ms10_332800000": "2",
                  "num_walls_3/pop_ppo_3net_invisible/grid5_img3_ni2_nw4_ms10_332800000": "3",
                  "num_walls_4/pop_ppo_3net_invisible/grid5_img3_ni2_nw4_ms10_332800000": "4",
                }
mode = "test"
num_networks = 3
    ...
    for setting_name in model_name_map:
        ...
        for seed in [1,2,3]:
            ...
            for pair in network_pairs:
                ...
                score_dict[pair] = load_score(f"../../logs/vary_wall/pickup_high_v1/{grid_size}/{model_name}/{pair}/{combination_name}/seed{seed}/mode_{mode}/{test_condition}/score.txt")
