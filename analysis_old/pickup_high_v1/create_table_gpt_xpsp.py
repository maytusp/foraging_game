...
if __name__ == "__main__":
    checkpoints_dict = {"gpt_ppo_2net_invisible" : {"seed1":153600000, "seed2":153600000, "seed3":153600000},
                         "gpt_sp_ppo_2net_invisible": {"seed1":153600000, "seed2":153600000, "seed3":153600000},
                        "gpt_ppo_3net_invisible": {'seed1': 153600000, 'seed2': 153600000, 'seed3':153600000},
                        }
    ...
    for model_name in checkpoints_dict.keys():
        ...
        for seed in range(1,4):
            ...
            saved_score_dir = f"../../logs/torch_pickup_high_v1/table_scores/{model_name}/{combination_name}_seed{seed}"
