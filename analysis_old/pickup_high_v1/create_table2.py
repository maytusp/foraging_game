# Table 2: Vocab Size vs Topsim vs SR
...
if __name__ == "__main__":
    checkpoints_dict = {
                        "pop_ppo_3net_invisible": {'seed1': 307200000, 'seed2': 307200000, 'seed3':307200000},
                        }
    ...
    for n_words in [4,8,16,32]:
        ...
        for seed in range(1,4):
            ...
            saved_fig_dir = f"figs/vary_n_words"
            saved_score_dir = f"../../logs/real_vary_n_words/exp2/{model_name}/{combination_name}_seed{seed}"
            ...
            for pair in network_pairs:
                ...
                log_file_path[pair] =  f"../../logs/real_vary_n_words/{model_name}/{pair}/{combination_name}/seed{seed}/mode_{mode}/normal/trajectory.pkl"
                sr_dict[pair] = load_score(f"../../logs/real_vary_n_words/{model_name}/{pair}/{combination_name}/seed{seed}/mode_{mode}/normal/score.txt")
            ...
            topsim_list.append(avg_topsim)

        # Save results
        results_dict[n_words] = {
            ...
            "topsim_mean" : np.mean(topsim_list),
            "topsim_std" : np.std(topsim_list),
        }
    ...
    for n_words, metrics in results_dict.items():
        df_data["Method"].append(n_words)
        df_data["topsim (mean ± std)"].append(f"{metrics['topsim_mean']:.3f} ± {metrics['topsim_std']:.3f}")
