...
#SBATCH -G 1                  # 1 GPU
#SBATCH -t 2-4                # Wallclock limit (1-0 is 1 day, 4-0 is the max permitted)
...
python -m scripts.torch_scoreg_layout.train_15net_c1 --seed 1 --comm_field 100 --num_networks 15 --agent-visible
