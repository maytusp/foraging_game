...
# CUDA_VISIBLE_DEVICES=1 python -m scripts.pickup_high_v1.test_vary_population_3_6
...
if __name__ == "__main__":
    ...
    for num_walls in [1,2,3,4,0]:
        args.grid_size = 5
        args.test_max_step = args.max_steps
        args.num_walls = num_walls
        for seed in [1,2,3]:
            for i in range(args.num_networks):
                for j in range(i+1):
                    args.seed = seed
                    args.n_words = 4
                    args.combination_name = f"grid{args.train_grid_size}_img{args.image_size}_ni{args.N_i}_nw{args.n_words}_ms{args.max_steps}"
                    ...
                    args.saved_dir = f"logs/vary_num_walls/num_walls_{args.num_walls}/{args.model_name}/{network_pairs}/{args.combination_name}_{args.model_step}/seed{args.seed}/mode_{args.mode}"
