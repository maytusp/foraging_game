...
# CUDA_VISIBLE_DEVICES=1 python -m scripts.pickup_high_v1.test_all_pairs_torch
    ...
    for seed in [3]:
        ...
        for i in range(args.num_networks):
            for j in range(args.num_networks):
                ...
                args.saved_dir = f"logs/torch_pickup_high_v1/train_gpuenv_eval_cpuenv/{args.model_name}/{network_pairs}/{args.combination_name}_{args.model_step}/seed{args.seed}/mode_{args.mode}"
