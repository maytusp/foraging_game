        ...
        for seed in [1,2,3]:
            for i in range(args.num_networks):
                for j in range(i+1):
                    ...
                    args.saved_dir = f"logs/vary_grid_size/test_grid_size_{args.grid_size}/{args.model_name}/{network_pairs}/{args.combination_name}_{args.model_step}/seed{args.seed}/mode_{args.mode}"
