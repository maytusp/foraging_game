...
# python -m scripts.pickup_high_v1.test_unseen_middle_position
        ...
        for seed in [1,2,3]:
            for i in range(args.num_networks):
                for j in range(i+1):
                    ...
                    args.saved_dir = f"logs/pickup_high_v1/test_unseen_middle_position/{args.model_name}/{network_pairs}/{args.combination_name}_{args.model_step}/seed{args.seed}/mode_{args.mode}"
