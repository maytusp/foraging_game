...
# CUDA_VISIBLE_DEVICES=1 python -m scripts.pickup_high_v1.train_visible_no_pressure_seed1
@dataclass
class Args:
    seed: int = 1
    ...
    if load_pretrained:
        ...
        ckpt_path = {
                    a: f"checkpoints/pickup_high_v1/pop_ppo_12net_invisible/grid5_img3_ni2_nw16_ms10/seed1/agent_{a}_step_51200000.pt" for a in range(num_networks)
                    }
    visualize_loss = True
...
if __name__ == "__main__":
    ...
    writer = SummaryWriter(f"runs/pickup_high_v1/fully_visible_score/{run_name}")
    writer.add_text(
        "hyperparameters",
