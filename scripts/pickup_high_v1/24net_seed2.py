...
class Args:
    ...
    if load_pretrained:
        pretrained_global_step = 1536000000
        learning_rate = 2e-4
        print(f"LOAD from {pretrained_global_step}")
        ckpt_path = {
                    a: f"checkpoints/pickup_high_v1/pop_ppo_24net_invisible_until1.5B/grid5_img3_ni2_nw16_ms10/seed1/agent_{a}_step_1536000000.pt" for a in range(num_networks)
                    }
    visualize_loss = True
