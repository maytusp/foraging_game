...
# python -m scripts.pickup_high_v1.test_ablate_3net_no_time_pressure
...
class Args:
    ...
    model2step = {
                "pop_ppo_3net_invisible_ablate_message_no_time_pressure/grid5_img3_ni2_nw4_ms10" : 204800000,
                }
