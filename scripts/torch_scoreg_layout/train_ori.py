...
def scheduled_max_steps(global_step, total_timesteps, args):
    if global_step < total_timesteps * 0.5:
        return args.max_steps
    if global_step < total_timesteps * 0.75:
        return args.mid_max_steps
    return args.final_max_steps
...
if __name__ == "__main__":
    ...
    global_step = 0
    current_max_steps = scheduled_max_steps(global_step, args.total_timesteps, args)
