...
from environments.torch_scoreg_layout import TorchForagingEnv, EnvConfig, simple_layout_7x7
from utils.process_data import *
from models.pickup_models import PPOLSTMCommAgent
# CUDA_VISIBLE_DEVICES=1 python -m scripts.torch_scoreg_layout.train_visinv --seed 1 --comm_field 100 --num_networks 3 --image_size 5 --no-agent-visible --num-foods 4 --total-timesteps 400000000
# CUDA_VISIBLE_DEVICES=1 python -m scripts.torch_scoreg_layout.train_visinv --seed 1 --comm_field 100 --num_networks 3 --image_size 5 --agent-visible --num-foods 4 --total-timesteps 400000000
...
def set_env_max_steps(envs, max_steps):
    envs.cfg.max_steps = max_steps
    envs._max_steps_f = float(max_steps)
...
if __name__ == "__main__":
    ...
    cfg = EnvConfig(
        ...
        food_spawn_on_agent_cells=args.food_spawn_on_agent_cells,
    )
    ...
    global_step = 0
    envs.set_food_spawn_on_agent_cells(False)
    initial_lstm_state = {}
