...
# CUDA_VISIBLE_DEVICES=0 python -m scripts.torch_scoreg_layout.prepare_ls_traj_mappo --num-networks 2 --model-name pop_mappo_2net_invisible --seed 1 --no-all-pairs --comm-field 100  --model-step 486400000
@dataclass
class Args:
    seed: int = 1
    cuda: bool = True
