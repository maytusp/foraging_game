...
class Args:
    ...
    time_pressure = False
    mode = "train"
    model_name = f"ppo_{num_networks}net"
    ...
    train_combination_name = f"grid{grid_size}_img{image_size}_ni{num_foods}_nw{n_words}_ms{max_steps}_comm_field{comm_field}"
    save_dir = f"checkpoints/torch_scoreg_layout/{model_name}/{train_combination_name}/seed{seed}/"
