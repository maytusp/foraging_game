...
# CUDA_VISIBLE_DEVICES=1 python -m scripts.pickup_rg.train_pop_3net
class Args:
    seed: int = 1
    ...
    agent_visible = False
    mode = "train"
    model_name = "pop_ppo_6net_10score"
    ...
    if load_pretrained:
        ...
        ckpt_path = {
                    a: f"checkpoints/pickup_rg/MODEL_NAME/SETTING/seed1/agent_{a}_step_947200000.pt" for a in range(num_networks)
                    }
    visualize_loss = True
