...
class Args:
    ...
    # saved_dir = f"logs/pickup_rg/{model_name}{network_pairs}/{combination_name}_{model_step}/seed{seed}/mode_{mode}"
    # if ablate_message:
...
if __name__ == "__main__":
    ...
    for i in range(args.num_networks):
        for j in range(args.num_networks):
            ...
            args.saved_dir = f"logs/pickup_rg/{args.model_name}/{network_pairs}/{args.combination_name}_{args.model_step}/seed{args.seed}/mode_{args.mode}"
