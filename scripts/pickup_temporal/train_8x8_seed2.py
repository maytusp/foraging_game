...
# python -m scripts.pickup_temporal.train_8x8_seed2
@dataclass
class Args:
    seed: int = 2
    ...
    if load_pretrained:
        ...
        ckpt_path = {
                    a: f"checkpoints/pickup_temporal/pop_ppo_3net_invisible/grid5_img3_ni2_nw4_ms20_freeze_dur6/seed2/agent_{a}_step_819200000.pt" for a in range(num_networks)
                    }
    visualize_loss = True
