...
# CUDA_VISIBLE_DEVICES=1 python -m scripts.pickup_temporal.train_8x8_ablate_3net_vis_seed1
@dataclass
class Args:
    seed: int = 1
    ...
    if load_pretrained:
        ...
        ckpt_path = {
                    a: f"checkpoints/pickup_temporal/pop_ppo_3net_ablate_message/grid5_img3_ni2_nw4_ms40_freeze_dur6/seed1/agent_{a}_step_460800000.pt" for a in range(num_networks)
                    }
    visualize_loss = True
