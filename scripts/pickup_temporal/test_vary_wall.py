...
class Args:
    ...
    combination_name = f"grid{train_grid_size}_img{image_size}_ni{N_i}_nw{n_words}_ms{max_steps}_freeze_dur{freeze_dur}"
...
if __name__ == "__main__":
    ...
    for num_walls in [0,1,2,3,4]:
        args.grid_size = 5
        args.num_walls = num_walls
        args.test_max_steps = args.max_steps
        for seed in range(1,4):
            ...
            for i in range(args.num_networks):
                for j in range(args.num_networks):
                    ...
                    args.saved_dir = f"logs/vary_wall/pickup_temporal/num_walls_{args.num_walls}/{args.model_name}/{network_pairs}/{args.combination_name}_{args.model_step}/seed{args.seed}/mode_{args.mode}"
