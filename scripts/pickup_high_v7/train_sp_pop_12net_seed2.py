...
# CUDA_VISIBLE_DEVICES=1 python -m scripts.pickup_high_v7.train_sp_pop_12net_seed2
@dataclass
class Args:
    seed: int = 2
    ...
    if load_pretrained:
        ...
        ckpt_path = {
                    a: f"checkpoints/pickup_high_v7/pop_ppo_15net_invisible/grid5_img3_ni2_nw4_ms10/seed1/agent_{a}_step_947200000.pt" for a in range(num_networks)
                    }
    visualize_loss = True
