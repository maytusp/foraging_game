# 26 July 2025: This code is for training a population of agents with Watts-Strogatz (WS) network for rebuttal
# The WS network is randomly generated by utils/graph_gen.py
# We have not investigated how variable os WS affect language structure yet
import os
import random
import time
...
# CUDA_VISIBLE_DEVICES=1 python -m scripts.pickup_high_v7.train_wsnet_15net_seed1
@dataclass
class Args:
    seed: int = 1
    ...
    agent_visible = False
    mode = "train"
    model_name = "wsk4p02_ppo_15net" # WS with k=4 p=0.2
