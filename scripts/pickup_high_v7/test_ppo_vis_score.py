...
class Args:
    ...
    model2step = { "pop_ppo_3net_invisible_visible_score":384000000,
                "pop_ppo_3net_invisible_visible_score_no_pressure":384000000,
                            }
...
if __name__ == "__main__":
    ...
    for model_name, model_step in args.model2step.items():
        ...
        for seed in [1,2,3]:
            for i in range(args.num_networks):
                for j in range(args.num_networks):
                    ...
                    args.saved_dir = f"logs/visible_scores/{args.model_name}/{network_pairs}/{args.combination_name}_{args.model_step}/seed{args.seed}/mode_{args.mode}"
