...
class Args:
    ...
    # ckpt_path = f"checkpoints/pickup_high_v7/{model_name}/{combination_name}/seed{seed}/agent_{selected_networks[0]}_step_{model_step}.pt"
    # ckpt_path2 = f"checkpoints/pickup_high_v7/{model_name}/{combination_name}/seed{seed}/agent_{selected_networks[1]}_step_{model_step}.pt"
    # saved_dir = f"logs/pickup_high_v7/{model_name}{network_pairs}/{combination_name}_{model_step}/seed{seed}/mode_{mode}"
    # if ablate_message:
...
if __name__ == "__main__":
    ...
    for i in range(0,1):
        for j in range(1,2):
            ...
            args.saved_dir = f"logs/debug/{args.model_name}/{network_pairs}/{args.combination_name}_{args.model_step}/seed{args.seed}/mode_{args.mode}"
