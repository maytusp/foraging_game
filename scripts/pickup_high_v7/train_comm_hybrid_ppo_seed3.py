...
# python -m scripts.pickup_high_v7.train_comm_hybrid_ppo_seed2
@dataclass
class Args:
    seed: int = 3
    ...
    if load_pretrained:
        ...
        ckpt_path = {
                    a: f"checkpoints/pickup_high_v7/pop_ppo_24net_invisible/grid5_img3_ni2_nw16_ms10/seed1/agent_{a}_step_51200000.pt" for a in range(num_networks)
                    }
    visualize_loss = True
