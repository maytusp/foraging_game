# Created: 28 Feb 2025
# The code is for training agents with separated networks during training and execution (no parameter sharing) for pickup_high_v2
...
class Args:
    ...
    save_dir = f"checkpoints/pickup_high_v2/{model_name}/{train_combination_name}/seed{seed}/"
    ...
    wandb_project_name: str = "pickup_high_v2"
