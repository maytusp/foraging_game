...
class Args:
    ...
    ckpt_path = f"checkpoints/pickup_high_v2/{model_name}/{combination_name}/seed{seed}/agent_0_step_{model_step}.pt"
    ckpt_path2 = f"checkpoints/pickup_high_v2/{model_name}/{combination_name}/seed{seed}/agent_1_step_{model_step}.pt"
    saved_dir = f"logs/pickup_high_v2/{model_name}/{combination_name}_{model_step}/seed{seed}/mode_{mode}"
    if ablate_message:
