...
from environments.torch_pickup_temporal import TorchForagingEnv, EnvConfig
...
if __name__ == "__main__":
    ...
    for model_name in args.name2step.keys():
        ...
        for seed in [1,2,3]:
            ...
            ckpt_dir = f"checkpoints/torch_pickup_temporal/{args.model_name}/{args.combination_name}/seed{args.seed}/"
            for i in range(args.num_networks):
                for j in range(i+1):
                    ...
                    args.saved_dir = (
                                f"logs/torch_pickup_temporal/{args.model_name}/{network_pairs}/"
