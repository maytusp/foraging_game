...
# CUDA_VISIBLE_DEVICES=1 python -m scripts.pickup_high_v5.test_dec_ppo_all_noise
# 
@dataclass
class Args:
    ...
    model2step = {"spawn_separately":563200000
                            }
if __name__ == "__main__":
    ...
    for model_name in args.model2step.keys():
        ...
        for seed in [3]:
            ...
            network_pairs = f"{i}-{j}"
            selected_networks = network_pairs.split("-")
            args.ckpt_path = f"checkpoints/pickup_high_v5/{args.model_name}/seed{args.seed}/agent_{selected_networks[0]}_step_{args.model_step}.pt"
            args.ckpt_path2 = f"checkpoints/pickup_high_v5/{args.model_name}/seed{args.seed}/agent_{selected_networks[1]}_step_{args.model_step}.pt"
