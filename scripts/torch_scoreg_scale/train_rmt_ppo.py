...
class Args:
    ...
    if load_pretrained:
        ...
        ckpt_path = {
            a: f"checkpoints/torch_scoreg_scale/project_mem/rmt_ppo_3net_invisible/grid5_img3_ni2_nw4_ms10/seed1/agent_{a}_step_102400000.pt"
