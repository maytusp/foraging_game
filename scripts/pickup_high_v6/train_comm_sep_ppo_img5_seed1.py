...
# CUDA_VISIBLE_DEVICES=1 python -m scripts.pickup_high_v6.train_comm_sep_ppo_img5_seed1
@dataclass
class Args:
    seed: int = 1
    ...
    visualize_loss = True
    ckpt_path = {
                0:f"checkpoints/pickup_high_v6/normal_condition/seed1/agent_0_step_179200000.pt", 
                1:f"checkpoints/pickup_high_v6/normal_condition/seed1/agent_1_step_179200000.pt"
                }
