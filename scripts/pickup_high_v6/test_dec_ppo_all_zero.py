...
# CUDA_VISIBLE_DEVICES=1 python -m scripts.pickup_high_v6.test_dec_ppo_all_zero
# 
@dataclass
class Args:
    ...
    model2step = { "normal_condition":563200000,
                    "add_time_pressure":563200000,
                            # "add_invisible":742400000,
                            
                            # "increase_complexity":742400000,
                            # "reduce_receptive_field":742400000,
                            }
