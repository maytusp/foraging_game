...
class Args:
    ...
    if load_pretrained:
        global_step = 281600000
        learning_rate = 2e-4
    visualize_loss = True
    ckpt_path = {
                0:f"checkpoints/pickup_high_v6/add_time_pressure/seed1/agent_0_step_281600000.pt", 
                1:f"checkpoints/pickup_high_v6/add_time_pressure/seed1/agent_1_step_281600000.pt"
                }
