...
class Args:
    ...
    save_dir = f"checkpoints/pickup_ind/{model_name}/{train_combination_name}/seed{seed}/"
    ...
    if load_pretrained:
        ...
        ckpt_path = {
                    a: f"checkpoints/pickup_ind/dec_ppo_ablate_message_visible_score/grid5_img5_ni2_nw4_ms10/seed1/agent_0_step_307200000.pt" for a in range(num_networks)
                    }
    visualize_loss = True
    ...
    wandb_project_name: str = "pickup_ind"
