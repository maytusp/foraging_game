...
if __name__ == "__main__":
    ...
    agent = PPOLSTMCommAgent(num_actions=num_actions, 
                                    grid_size=args.grid_size, 
                                    n_words=args.n_words, 
                                    embedding_size=16, 
    ...
    obs = torch.zeros((args.num_steps, args.num_envs, num_channels, args.image_size, args.image_size)).to(device) # obs: vision
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        # flatten the batch
        b_obs = obs.reshape((-1, num_channels, args.image_size, args.image_size))
