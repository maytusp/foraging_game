# Created: 28 Feb 2025
# The code is for training agents with separated networks during training and execution (no parameter sharing) for pickup_high_v4
...
class Args:
    ...
    agent_visible = False
    mode = "train"
    model_name = "capacity_dec_ppo" # vary capacity
    ...
    train_combination_name = f"grid{grid_size}_img{image_size}_ni{N_i}_nw{n_words}_l{message_length}_ms{max_steps}"
