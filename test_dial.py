...
from environments.environment_pickup_high_dial import *
from utils import *
...
@dataclass
class Args:
    ckpt_path = "checkpoints/pickup_high_invisible/ppo_dial/model_step_51M.pt"
    ...
    saved_dir = "logs/pickup_high_invisible/ppo_dial_51M/zero"
