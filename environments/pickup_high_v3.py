...
# TODO Add communication punishment if agents are not in range
import pygame
import numpy as np
import random
import time
...
class Environment(ParallelEnv):
    ...
    def reset(self, seed=42, options=None):
        ...
        # map from food_id to agent_id that can see its score
    ...
    def random_position(self):
        while True:
            ...
            if self.grid[pos[0], pos[1]] is None and self.min_dist(pos,1):
