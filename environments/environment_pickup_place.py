...
class Environment(ParallelEnv):
    ...
    def __init__(self, truncated=False, torch_order=True, num_agents=2, n_words=10, message_length=1, use_message=False, use_pointgoal=True, seed=42, food_ener_fully_visible=True):
        np.random.seed(seed)
