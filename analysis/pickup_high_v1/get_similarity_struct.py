...
if __name__ == "__main__":
    checkpoints_dict = {
        "ring_ppo_15net_invisible" : {'seed1': 819200000, 'seed2': 819200000, 'seed3':819200000},
        ...
        # "wsk4p02_sp_ppo_15net_invisible": {'seed1': 819200000, 'seed2': 819200000, 'seed3':819200000},
        "optk2e30_ppo_15net_invisible": {'seed1': 665600000, 'seed2': 819200000, 'seed3':819200000},
        "optk2e30_sp_ppo_15net_invisible": {'seed1': 819200000, 'seed2': 819200000, 'seed3':819200000},
        "ccnet_ppo_15net_invisible" : {'seed1': 1126400000, 'seed2': 819200000, 'seed3':819200000},
        "ccnet_sp_ppo_15net_invisible" : {'seed1': 819200000, 'seed2': 819200000, 'seed3':819200000},
        }
    connected_dict = {
                     "ring_ppo_15net_invisible": [[i,(i+1) % 15] for i in range(15)],
                     "wsk4p02_ppo_15net_invisible": [[0, 1], [0, 2], [1, 2], [1, 3], [2, 3], [2, 4], [3, 4], [3, 5], [4, 5], [4, 6], [5, 7], [6, 7], [7, 8], [8, 9], [8, 10], [9, 10], [10, 12], [11, 12], [11, 13], [12, 13], [14, 0], [14, 1], [5, 13], [6, 7], [7, 10], [9, 6], [10, 8], [12, 5], [13, 6], [13, 5]],
    ...
    connected_dict["ring_sp_ppo_15net_invisible"] = connected_dict["ring_ppo_15net_invisible"]
    connected_dict["wsk4p02_sp_ppo_15net_invisible"] = connected_dict["wsk4p02_ppo_15net_invisible"]
    connected_dict["optk2e30_sp_ppo_15net_invisible"] = connected_dict["optk2e30_ppo_15net_invisible"]
    connected_dict["ccnet_sp_ppo_15net_invisible"] = connected_dict["ccnet_ppo_15net_invisible"]
    ...
    for model_name in checkpoints_dict.keys():
        ...
        for num_networks in [15]:
            ...
            for s_idx, seed in enumerate(SEEDS):
                ...
                saved_fig_dir = f"plots/population/struct_pop/sr_lang_sim"
                saved_score_dir = f"../../logs/struct_pop/exp2/{model_name}/{combination_name}_seed{seed}"
