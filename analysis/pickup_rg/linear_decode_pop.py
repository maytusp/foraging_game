...
if __name__ == "__main__":
    ...
    checkpoints_dict = {
                    "pop_ppo_6net_invisible": {'seed1': 204800000, 'seed2': 204800000, 'seed3':204800000},
                    }
    ...
    for seed in range(1,4):
        ...
        combination_name = f"/grid5_img3_ni2_nw4_ms6_{model_step}"

        
        for i in range(3):
            for j in range(i+1):
                log_file_path = f"../../logs/pickup_rg/{model_name}/{i}-{j}/{combination_name}/seed{seed}/mode_test/normal/trajectory.pkl"
