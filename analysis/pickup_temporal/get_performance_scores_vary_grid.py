...
model_name_map = {
                 "test_grid_size_5/pop_ppo_3net_invisible/grid5_img3_ni2_nw4_ms20_freeze_dur6_819200000": "5x5",
                  "test_grid_size_6/pop_ppo_3net_invisible/grid5_img3_ni2_nw4_ms20_freeze_dur6_819200000": "6x6",
                  "test_grid_size_7/pop_ppo_3net_invisible/grid5_img3_ni2_nw4_ms20_freeze_dur6_819200000": "7x7",
                }
mode = "train"
num_networks = 3
    ...
    for setting_name in model_name_map:
        ...
        for seed in [1,2,3]:
            ...
            for pair in network_pairs:
                ...
                score_dict[pair] = load_score(f"../../logs/vary_grid_size/pickup_temporal/{grid_size}/{model_name}/{pair}/{combination_name}/seed{seed}/mode_{mode}/{test_condition}/score.txt")
