...
SEASON_COLORS = [
    (255, 153, 51),   # Autumn (Orange)
    (200, 230, 255),  # Winter (Light Blue)
    (144, 238, 144),  # Spring (Light Green)
    (255, 223, 0)     # Summer (Yellow)
]
...
def visualize_environment(environment, step):
    ...
    # Fill background
    screen.fill(SEASON_COLORS[environment.curr_season])
    ...
    for food in environment.foods:
        if food.collecting_season == environment.curr_season:
